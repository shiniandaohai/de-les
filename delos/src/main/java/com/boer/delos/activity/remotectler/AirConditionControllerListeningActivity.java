 ...
 */
public class AirConditionControllerListeningActivity extends BaseListeningActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSeekArc.setOnSeekArcChangeListener(new SeekArc.OnSeekArcChangeListener() {
            ...
            public void onStopTrackingTouch(SeekArc seekArc) {
                if(mAcdata.getIsOn() == 1){
                    if(mAcdata.getMode() != 4&&mAcdata.getMode()!=3){
            ...
            public void onDisableTouch(SeekArc seekArc) {
                ...
                else if(mAcdata.getMode()==3){
                    toastUtils.showErrorWithStatus("通风模式下无法调节温度");
                    return;
                }
            }
       ...
       /* Animation translateAnimation= AnimationUtils.loadAnimation(this, R.anim.out_to_up);//加载Xml文件中的动画
        ...
        WindowManager wm = (WindowManager) AirConditionControllerListeningActivity.this
    ...
    private void updateView() {
        if(mAcdata.getIsOn() == 1) {
            ...
            if(mAcdata.getMode()!=3&&mAcdata.getMode()!=4){
   ...
   */
    ...
    private void initView() {
        ...
        vTitle.setBackgroundColor(Color.parseColor("#128ce3"));
        ...
        ivRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mDevice != null) {
                    ...
                    devices.add(mDevice);
                    DeviceUpdateStatus.setCommonDevice(AirConditionControllerListeningActivity.this, devices, toastUtils);
                }
            }
        });
