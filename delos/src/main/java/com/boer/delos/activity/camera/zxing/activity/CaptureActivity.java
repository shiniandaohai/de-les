package com.boer.delos.activity.camera.zxing.activity;
...
import com.boer.delos.activity.camera.zxing.decoding.CaptureActivityHandler;
import com.boer.delos.activity.camera.zxing.decoding.InactivityTimer;
import com.boer.delos.activity.camera.zxing.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback {
    ...
    public void handleDecode(Result result, final Bitmap barcode) {
        ...
        if (resultString.equals("")) {
            Toast toast = Toast.makeText(this, "失败!",
                    Toast.LENGTH_LONG);
