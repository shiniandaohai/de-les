...
/**/
public class ShowRequestPopupWindow {
    private Context mContext;
    private View topView;
    private IShowRequest iShowRequest;
    private PopupWindow pop;
    private TextView tv_textCancel, tv_textSure, tv_title, tv_content;
    String title, content;


    public ShowRequestPopupWindow(Context context, View topView, String title, String content) {
        mContext = context;
    ...
    public void showPopupWindow() {
        ...
        View view = inflater.inflate(R.layout.popup_window_request, null);
