...
public class ShowSexPopupWindow {
    ...
    public ShowSexPopupWindow(Context context, View topView) {
        mContext = context;
    ...
    public void showPopupWindow() {
        ...
        sex = new String[]{mContext.getString(R.string.male), mContext.getString(R.string.female)};
        strSex = sex[0];
        ...
        final ArrayWheelAdapter<String> adapter = new ArrayWheelAdapter<>(mContext, sex);
...
//        wheel1.setCyclic(true);
        wheel1.addScrollingListener(new OnWheelScrollListener() {
            ...
            public void onScrollingFinished(WheelView wheel) {
                ...
                strSex = adapter.getItemText(wheel.getCurrentItem()).toString();
        ...
        tv_textSure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (showSexPopupWindowInterface != null) {
                    ...
                    showSexPopupWindowInterface.rightButtonClick(strSex);
                    dismissPop();
                }
            }
        });
