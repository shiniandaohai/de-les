...
public class MySpinnerAdapter2 extends MyBaseAdapter<ShareUser.UserBean> {

    public MySpinnerAdapter2(Context mContext, List<ShareUser.UserBean> listData, int itemLayoutId) {
