package com.boer.delos.widget.ui;
 ...
 */
public class OverScrollBounceView extends FrameLayout implements OnTouchListener
{
	...
	public OverScrollBounceView(Context context)
	{
		this(context, null);
	}

	public OverScrollBounceView(Context context, AttributeSet attrs)
	{

		this(context, attrs, 0);
	}

	public OverScrollBounceView(Context context, AttributeSet attrs, int defStyle)
	{
	...
	protected boolean onRequestFocusInDescendants(int direction, Rect previouslyFocusedRect)
	{
		...
		// groupConvert from forward / backward notation to up / down / left / right
		// (ugh).
